...
; *******************************************************************
			...
			define DAAD_PRINT_MESSAGE_ES 	$1629
...
; ---- read the file
						...
						POP 	IX
						POP 	BC
						SET 	6, (IX-1) ; Required by DAAD to print messages
						PUSH 	BC
						PUSH 	IX
						...
						LD 		A, D
						AND 	7
						LD 		D, A 		  ; Remove first 5 bits to get the offset withing this specific file

						LD 		HL, BUFFER2K_ADDR
						ADD 	HL, DE
						
						EI
						CALL 	DAAD_PRINT_MESSAGE_ES
						DI
