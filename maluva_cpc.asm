...
; ---- read the file
						...
						LD 		HL, BUFFER2K_ADDR
						ADD 	HL, DE
						PUSH 	HL			; Preserve the address where the xmessage has been loaded
						...
						INC 	HL
						LD 		D, (HL)
						EX      HL, DE		; HL points to messages table
						LD 		E, (HL)
						INC		HL
						LD 		D, (HL)  
						DEC		HL				; Now DE has the value of first message pointer, and HL points to where that pointer is
