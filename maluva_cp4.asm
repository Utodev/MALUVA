...
LoadAttrs			LDA #<PLUS4_ATTRS_RAM
					...
					LDA #$20
					STA PatchJSR1           ; Attributes had been loaded once at least, so we can call "ConvertColors", change BIT to JST below
...
PatchJSR1			BIT ConvertColors
                    ...
                    LDA #$2c
					STA PatchJSR1           ; Once ConvertColors has been called, when change again JST to BIT, so it's not called for other functions
